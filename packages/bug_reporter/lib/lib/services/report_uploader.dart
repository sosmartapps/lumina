...
class ReportUploader {
  ...
  /// Silently auto-submit a crash report without user interaction.
  /// Called on app restart when a previous crash was detected.
  static Future<bool> autoSubmitCrash({
    ...
    try {
      final body = jsonEncode({
        'appName': appName,
        'type': 'crash',
        'description': '[Auto-reported crash] App crashed on previous session',
        'crashLog': crashLog,
        'deviceModel': deviceModel,
        'osVersion': osVersion,
        'appVersion': appVersion,
        'buildNumber': buildNumber,
        'source': 'auto_crash_detect',
      });
