...
- **Daily Activities library (2026-07-13)** built but NOT device-tested — caregiver "Daily Activities" dashboard entry → `activity_library_screen.dart`, 16 Montessori-style templates (`core/data/activity_templates.dart`) instantiate normal Reminders (existing photo-verify pipeline; no rules/function changes). Test: add activity w/ photo toggle, patient popup + TTS fires, photo verify, caregiver override. Feature 1 of 5 — cognition roadmap in Dev Planner + `docs/cognitive-engagement-research.md`
